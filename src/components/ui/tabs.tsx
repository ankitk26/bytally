	...
	return (
		<TabsPrimitive.Tab
			...
			className={cn(
				...
				"after:bg-foreground after:absolute after:opacity-0 after:transition-opacity group-data-horizontal/tabs:after:inset-x-0 group-data-horizontal/tabs:after:-bottom-1.25 group-data-horizontal/tabs:after:h-0.5 group-data-vertical/tabs:after:inset-y-0 group-data-vertical/tabs:after:-right-1 group-data-vertical/tabs:after:w-0.5 group-data-[variant=line]/tabs-list:data-active:after:opacity-100 data-[state=active]:after:bg-foreground data-[state=active]:text-foreground text-muted-foreground data-[state=inactive]:hover:text-foreground/80 relative flex items-center gap-1.5 px-1 pb-3 pt-0 text-xs font-medium transition-colors after:-bottom-px after:left-0 after:right-0 after:h-0.5 data-[state=active]:after:opacity-100",
				className,
			)}
			{...props}
		/>
